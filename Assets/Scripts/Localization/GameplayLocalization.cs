...
public class GameplayLocalization : MonoBehaviour
{
    ...
    private void EnLocalization()
    {
        ...
        Inventory.text = "<color=orange>[Tab]</color> Inventory";
        InMenu.text = "<color=orange>[U]</color> To Menu";
    ...
    private void TrLocalization()
    {
        ...
        Inventory.text = "<color=orange>[Tab]</color> Envanter";
        InMenu.text = "<color=orange>[U]</color> Menüde";
    ...
    private void RuLocalization()
    {
        ...
        Inventory.text = "<color=orange>[Tab]</color> Инвентарь";
        InMenu.text = "<color=orange>[U]</color> В Меню";
